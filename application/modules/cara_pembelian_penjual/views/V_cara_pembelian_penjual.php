...
<div class="sub-banner">
    <div class="container breadcrumb-area">
        <div class="breadcrumb-areas">
            ...
            <?php foreach ($tampil as $carapembelianpenjual) {
            $id = $carapembelianpenjual->id_tatacara;
            ?>
            </ul>
        </div>
    </div>
            ...
            <div class="col-md-6 sd">
                <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    <div class="card-body" style="height: 900px;">
                        <center><h4 class="heading" style="color: #000000;" ><?php echo $carapembelianpenjual->judulpembelian?></h4></center>
                        <p><?php echo $carapembelianpenjual->pembelian?></p>
                    </div>
                </div>
           </div>
            ...
            <div class="col-md-6 sd">
                <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    <div class="card-body" style="height: 450px;">
                        <center><h4 class="heading" style="color: #000000;"><?php echo $carapembelianpenjual->judulsyarat?></h4></center>
                        <p><?php echo $carapembelianpenjual->syaratketentuan?></p>
                    <?php } ?>
                    </div>
                </div>
            </div>
