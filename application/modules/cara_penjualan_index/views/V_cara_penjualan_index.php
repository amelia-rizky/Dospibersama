...
<div class="sub-banner">
    <div class="container breadcrumb-area">
        <div class="breadcrumb-areas">
            ...
            <?php foreach ($tampil as $carapenjualanindex) {
            $id = $carapenjualanindex->id_tatacara;
            ?>
            </ul>
        </div>
    </div>
       ...
       <div class="row">
           <div class="col-md-6 sd">
               <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    ...
                    <center><h4 class="heading" style="color: #000000;"><?php echo $carapenjualanindex->judulpenjualan?></h4></center>
                    <p><?php echo $carapenjualanindex->penjualan?></p>
       ...
       <div class="col-md-6 sd">
           <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
               <div class="card-body" style="height: 450px;">
                <center><h4 class="heading" style="color: #000000;"><?php echo $carapenjualanindex->judulsyarat?></h4></center>
                <p><?php echo $carapenjualanindex->syaratketentuan?></p>
              <?php } ?>
               </div>
            </div>
       </div>
