...
<div class="sub-banner">
    <div class="container breadcrumb-area">
        <div class="breadcrumb-areas">
            ...
            <?php foreach($tampil as $tatacaraindex) {
            $id = $tatacaraindex->id_tatacara;
            ?>
            </ul>
        </div>
    </div>
                ...
                <div class="col-md-6 sd">
                    <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                        <div class="card-body" style="height: 850px auto;">
                            <center><h4 class="heading" style="color: #000000;" ><?php echo $tatacaraindex->judulpembelian ?></h4></center>
                            <div class="crpbl" style="font-size: 13px;">
                                <p><?php echo $tatacaraindex->pembelian ?></p>
                            </div>
                         </div>
                     </div>
                </div>
            ...
            <div class="col-md-6 sd">
                <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    <div class="card-body" style="height: 975px;">
                        <center><h4 class="heading" style="color: #000000;"><?php echo $tatacaraindex->judulpenjualan ?></h4></center>
                        <p><?php echo $tatacaraindex->penjualan ?>
                        </p>
                    </div>
                 </div>
            </div>
            ...
            <div class="col-md-6 sd" style="margin-left: 25%;"><br>
                <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    <div class="card-body"><br>
                        <center><h4 class="heading" style="color: #000000;"><?php echo $tatacaraindex->judulsyarat ?></h4></center>
                        <p><?php echo $tatacaraindex->syaratketentuan ?></p>
                    <?php } ?>
                    </div>
                </div>
            </div>
