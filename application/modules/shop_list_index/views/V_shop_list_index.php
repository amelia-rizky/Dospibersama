    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-12">
                ...
                <div class="iklanshop">
                    <img src="assets/img/iklan/shopee-blackpink.jpg" style="width: 92%; height: 35%; position: absolute;">
                </div><br>
                <div class="iklanshop2">
                    <img src="assets/img/iklan/pocari.jpg" style="margin-top: 130%; width: 92%; height: 22%; position: absolute;">
                </div>
            </div>
