        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    <div class="property-thumbnail">
                        <a href="shop_detail_penjual" class="property-img">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_penjual">Sapi Limosin</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_penjual">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_penjual">Sapi Brahman</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_penjual">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_penjual">Sapi Simmental</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_penjual">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_penjual">Kambing Etawa</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_penjual">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_penjual">Kambing Jawa Randu</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_penjual">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_penjual">Kambing Boer</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_penjual">
            ...
            <div style="margin-left: 78%;">
                <a href="<?php echo base_url('shop_list_penjual');?>" class="btn btn-white">Selengkapnya&nbsp;<i class="fa fa-long-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
