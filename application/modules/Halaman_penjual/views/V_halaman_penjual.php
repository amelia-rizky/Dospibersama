                    ...
                    <div class="row row-4">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 search-col">
                            <button class="btn white-btn btn-search btn-block">
                                <a href="properties-grid-leftsidepenjual.html"><i class="fa fa-search"></i><strong>Cari</strong></a>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspenjual.html">Sapi Limosin</a>
                        </h1>
                        <div class="location">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspenjual.html">Sapi Brahman</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspenjual.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspenjual.html">Sapi Simmental</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspenjual.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspenjual.html">Kambing Etawa</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspenjual.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspenjual.html">Kambing Jawa Randu</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspenjual.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspenjual.html">Kambing Boer</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspenjual.html">
            ...
            <div style="margin-left: 78%;">
                <a href="properties-grid-leftsidepenjual.html" class="btn btn-white">Selengkapnya&nbsp;<i class="fa fa-long-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-2">
                    ...
                    <div class="detail">
                        ...
                        <h4>
                            <a href="properties-grid-leftsidepenjual.html">Sapi Limosin</a>
                        </h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-2">
                    ...
                    <div class="detail">
                        ...
                        <h4>
                            <a href="properties-grid-leftsidepenjual.html">Kambing Etawa</a>
                        </h4>
            ...
            <div class="col-lg-4 col-md-6 none-992">
                <div class="blog-2">
                    ...
                    <div class="detail">
                        ...
                        <h4>
                            <a href="properties-grid-leftsidepenjual.html">Kambing Jawa Randu</a>
                        </h4>
