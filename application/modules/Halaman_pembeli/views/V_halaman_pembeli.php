                    ...
                    <div class="row row-4">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 search-col">
                            <button class="btn white-btn btn-search btn-block">
                                <a href="properties-grid-leftsidepembeli.html"><i class="fa fa-search"></i><strong>Cari</strong></a>
                            </button>
                        </div>
                    </div>
                </div>
...
<div class="featured-properties content-area">
    <div class="container">
        ...
        <div class="main-title">
            <h1>Product Unggulan Kami</h1>
            <p>Kami Menjual Berbagai Jenis Sapi & Kambing</p>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspembeli.html">Sapi Limosin</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspembeli.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspembeli.html">Sapi Brahman</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspembeli.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspembeli.html">Sapi Simmental</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspembeli.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspembeli.html">Kambing Etawa</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspembeli.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspembeli.html">Kambing Jawa Randu</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspembeli.html">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-detailspembeli.html">Kambing Boer</a>
                        </h1>
                        <div class="location">
                            <a href="properties-detailspembeli.html">
            ...
            <div style="margin-left: 78%;">
                <a href="properties-grid-leftsidepembeli.html" class="btn btn-white">Selengkapnya&nbsp;<i class="fa fa-long-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="advantages content-area">
    <div class="container">
        ...
        <div class="main-title-2 text-center">
            <h1>Tentang Dospi</h1>
            <p>Dospi Adalah Sebuah Website Yang Menerapkan Konsep Bisnis,dan Berjalan Di Bidang Penjualan Hewan,terutama Sapi Dan Kambing. 
            </p>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12" style="margin-left: 13%;">
                <div class="advantages-box scroll-behavior">
                    <div class="icon">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="advantages-box">
                    ...
                    <div class="detail">
                        <h5>Email</h5>
                        <p>Dospi@gmail.com <br><br><br><br></p>
                    </div>
                </div>
            </div>
...
<div class="categories content-area-13">
    <div class="container">
        ...
        <div class="main-title text-center">
            <h1>Layanan Kami</h1>
            <p>Konsep Bisnis Yang Berjalan Di Bidang Penjualan Hewan,terutama Sapi Dan Kambing.</p>
        </div>
        <div class="row row-2">
            <div class="col-lg-4 col-md-12" style="margin-left: 15%;">
                <div class="row">
                                ...
                                <div class="category-overlay">
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="properties-grid-leftsidepembeli.html">Kambing</a>
                                        </h3>
            ...
            <div class="col-lg-4 col-md-12" style="margin-left: 5%;">
                <div class="row">
                    <div class="col-md-6 col-lg-12 col-pad">
                        <div class="category">
                            <div class="category_bg_box cat-2-bg">
                                <div class="category-overlay">
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="properties-grid-leftsidepembeli.html">Sapi</a>
                                        </h3>
                                        <h4 class="category-subtitle">Product Kami</h4>
                                    </div>
                                </div>
...
<div class="blog-section content-area">
    <div class="container">
        ...
        <div class="main-title">
            <h1>Rekomendasi</h1>
            <p>Rekomendasi Hewan Ternak Yang Paling Banyak di Cari</p>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-2">
                    ...
                    <div class="detail">
                        ...
                        <h4>
                            <a href="properties-grid-leftsidepembeli.html">Sapi Limosin</a>
                        </h4>
                        <p>Sapi Yang Merupakan sapi tergemuk di perternakan daerah kami. cocok banget buat Qurban serta buat hajatan besar</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-2">
                    ...
                    <div class="detail">
                        ...
                        <h4>
                            <a href="properties-grid-leftsidepembeli.html">Kambing Etawa</a>
                        </h4>
                        <p>Merupakan Kambing Tersubur Dan salah satu kambing jenis tergemuk di daerah kami dan cocok banget buat aqiqah dll</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 none-992">
                <div class="blog-2">
                    ...
                    <div class="detail">
                        ...
                        <h4>
                            <a href="properties-grid-leftsidepembeli.html">Kambing Jawa Randu</a>
                        </h4>
                        <p>merupakan kambing yang kurang cocok buat Hajatan Hanya cocok buat bakar dan kegiatan kecil kecilan </p>
                    </div>
                </div>
            </div>
        </div>
