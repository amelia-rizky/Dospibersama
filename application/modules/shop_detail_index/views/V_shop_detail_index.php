            ...
            <div class="col-lg-8 col-md-12 col-xs-12">
                <div class="properties-details-section">
                    ...
                    <div class="widget-2 advanced-search bg-grea-2 d-lg-none d-xl-none">
                        <h3 class="sidebar-title">Properti Pencarian</h3>
                        <form method="GET">
                    ...
                    <div class="contact-2 ca mb-50">
                        ...
                        <form action="#" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="form-group number col-md-6">
                                <input type="text" name="phone" class="form-control" placeholder="Password" style="color: #333;">
                            </div>
                ...
                <div class="sidebar-right">
                    ...
                    <div class="detail">
                        ...
                        <!--Modal: modalConfirmDelete-->
                            <div class="modal fade" id="pesanpenjual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                              aria-hidden="true">
                              <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
                                ...
                                <!--Body-->
                                  ...
                                  <div class="modal-header d-flex justify-content-center">
                                    <p style="font-size: 15px; color: #333;" class="heading"><strong style="font-size: 20px; color: red;">Peringatan ! !</strong> <br><br>Anda Diharuskan Untuk<strong style="color: blue;">"Login"</strong>Terlebih Dahulu Jika Ingin Memulai Chat Dengan Penjual !</p>
                                  </div>
