        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    <div class="property-thumbnail">
                        <a href="shop_detail_pembeli" class="property-img">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_pembeli">Sapi Limosin</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_pembeli">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_pembeli">Sapi Brahman</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_pembeli">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_pembeli">Sapi Simmental</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_pembeli">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_pembeli">Kambing Etawa</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_pembeli">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_pembeli">Kambing Jawa Randu</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_pembeli">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="property-box">
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="shop_detail_pembeli">Kambing Boer</a>
                        </h1>
                        <div class="location">
                            <a href="shop_detail_pembeli">
