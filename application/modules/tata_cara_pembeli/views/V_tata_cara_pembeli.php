    ...
    <div class="container breadcrumb-area">
        <div class="breadcrumb-areas">
            ...
            <ul class="breadcrumbs">
                ...
                <?php foreach($tampil as $tatacarapembeli) {
            $id = $tatacarapembeli->id_tatacara;
            ?>
            </ul>
        </div>
    </div>
                ...
                <div class="col-md-6 sd">
                    <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                        <div class="card-body" style="height: 850px auto;">
                            <center><h4 class="heading" style="color: #000000;" ><?php echo $tatacarapembeli->judulpembelian ?></h4></center>
                            <div class="crpbl" style="font-size: 13px;">
                                <p><?php echo $tatacarapembeli->pembelian?></p>
                            </div>
                         </div>
                     </div>
                </div>
            ...
            <div class="col-md-6 sd">
                <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    <div class="card-body" style="height: 975px;">
                        <center><h4 class="heading" style="color: #000000;"><?php echo $tatacarapembeli->judulpenjualan?></h4></center>
                        <p><?php echo $tatacarapembeli->penjualan?></p>
                    </div>
                 </div>
            </div>
            ...
            <div class="col-md-6 sd" style="margin-left: 25%;"><br>
                <div class="card" style="background-color: #ffffff; padding: 5px; border: 1px solid black; box-shadow: 3px 3px 3px 3px rgba(38, 38, 38,.3);">
                    <div class="card-body"><br>
                        <center><h4 class="heading" style="color: #000000;"><?php echo $tatacarapembeli->judulsyarat?></h4></center>
                        <p><?php echo $tatacarapembeli->syaratketentuan?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
